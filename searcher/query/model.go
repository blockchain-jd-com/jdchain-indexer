...
func (u *User) GetHashID() string {
	return u.PublicKey + u.Address.Value
}
...
func (ds *Account) GetHashID() string {
	return ds.PublicKey + ds.Address.Value
}
...
func (c Contract) GetHashID() string {
	return c.PublicKey + c.Address.Value
}
